...
Es ergibt sich jedoch das Bild, dass es zwei große cortikale Pfa-
de der visuellen Verarbeitung gibt: einen, der sich dorsal von der primären Sehrinde zum
Scheitellappen erstreckt, und einen, der ventral zum Schläfenlappen zieht (Abb. 10.27).
Der dorsale Pfad scheint für die Analyse der visuellen Bewegung und die visuelle Kon-
trolle von Handlungen zuständig zu sein. Der ventrale Pfad ist stärker an der bewussten
Wahrnehmung der visuellen Welt und der Wiedererkennung von Objekten beteiligt. 

Die Eigenschaften der Neuronen des dorsalen Pfads ähneln denjenigen der magnozellulä-
ren Neuronen in V1 stark, während die Neuronen des ventralen Pfads in ihren Eigenschaf-
ten eher den Parvo-Interblob- und Blobzellen in V1 gleichen. Jeder der beiden extrastri-
ären Pfade erhält jedoch Signale von sämtlichen Pfaden im primären visuellen Cortex.
\textsuperscript{\cite[10]{neurowissenschaften_baer}}
